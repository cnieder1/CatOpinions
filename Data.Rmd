...
pie(table(A),main = "Roaming Cats HARM Wildlife",xlab = "1 = Disagree; 2 = Neutral; 3 = Agree", col = "turquoise2")



test <- structure(list(Type = structure(c(1L, 2L, 3L,1L, 2L, 3L,1L, 2L, 3L,1L, 2L, 3L,1L, 2L, 3L,1L, 2L, 3L,1L, 2L, 3L,1L, 2L, 3L,1L, 2L, 3L,1L, 2L, 3L), .Label = c("Agree", "Neutral", "Disagree"), class = "factor"), Question = structure(c(1L,1L,1L, 2L,2L,2L,3L,3L, 3L, 4L,4L,4L,5L,5L,5L, 6L,6L,6L,7L,7L, 7L,8L,8L, 8L, 9L,9L,9L, 10L,10L,10L), .Label = c("1A", "1B", "2A", "2B", "3A", "3B", "4A", "4B", "5A", "5B"), class = "factor"), 
    Cnt = c(207L, 116L, 200L, 128L, 110L, 287L, 282L, 96L, 163L, 193L,98L, 216L,430L, 59L, 55L, 176L, 54L, 274L, 343L, 104L, 80L, 167L,107L, 247L,223L, 100L,234L, 162L, 98L, 231L)), row.names = c(NA, 
-30L), .Names = c("Opinion", "Question", "Number"), class = "data.frame")

ggplot(data = test, aes(x = "", y = Number, fill = Opinion )) + 
